...
export default {
  channelMonitorV2: {
    ...
    settings: {
      ...
      platformsHint:
        'Only listed models are counted. Unlisted models are excluded; leave empty to stop monitoring this platform.',
      modelsPlaceholder: 'Exact model names, separated by commas; empty = no models monitored',
      badgeNoModels: 'No models configured',
      badgeListedModels: 'Listed models only',
      ...
      namedModelsEmpty: 'No models are configured for enabled platforms: monitoring will show no data and count no models.',
      namedModelsCount: 'Counting only {count} configured model dimensions on enabled platforms; unlisted models are excluded from all monitoring metrics.',
      ...
      userContract: {
        ...
        models: 'Only exact model names configured for each platform are counted; unlisted models are excluded and empty lists stop monitoring that platform.',
      },
    },
    admin: {
      descriptionV1:
