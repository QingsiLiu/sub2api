export default {
  ...
  keys: {
    ...
    planGroupRateHint: 'Quota consumption uses the selected group’s subscription multiplier.',
    groupModelCatalogHint: 'Composite keys require a declared model catalog. Configure model allowlists or account model mappings; the OpenAI protocol alone does not declare model support.',
    billingSource: "Settlement",
    balanceOnly: "Balance only",
    specifiedSubscription: "Specified subscription",
    legacySettlement: "Keep existing settlement (legacy key)",
    legacySettlementHint: "Changing settlement opts this key into the new group and subscription settings.",
    ...
    planQuotaHint: "Plan quotas apply to linked subscriptions. Changing them preserves usage and expiry. Empty or 0 means unlimited.",
    quotaConsumption: "Subscription quota consumption",
    billingSourceColumn: "Settlement source",
    finalMultiplier: "Effective multiplier",
    ...
    subscriptionRequired: 'Select a subscription quota.',
    failedToLoadRoutes: 'Failed to load subscription routes.',
    routePreferencesLabel: 'Provider routes',
    routePreferencesHint: 'Choose a default route for each provider. The displayed multiplier consumes the shared subscription quota.',
