export default {
  ...
  payment: {
    ...
    receipt: {
      ...
      sectionTrade: 'Transaction',
      paidAt: 'Paid at',
      method: 'Payment method',
      tradeNo: 'Transaction no.',
      settled: 'Settlement',
      settledYes: 'Credited',
      settledRefunded: 'Refunded',
      merchant: 'Payee',
      currency: 'Currency',
      sectionItems: 'Items',
      itemName: 'Item',
      ...
      itemBalanceDesc: 'Credit for API usage',
      itemSubscription: 'Subscription plan',
      itemSubscriptionDesc: 'Credit for subscription usage',
      downloadFailed: 'Could not download the receipt. Please try again.',
    },
    result: {
    ...
    groupRates: {
      ...
      hint: 'Only groups that currently allow subscription settlement. Return to this page after an admin save.',
      other: 'Other',
    },
