export default {
    ...
    groups: {
      ...
      subscriptionRateMultiplierHint: 'Multiplier used by subscription requests; balance requests use the regular rate multiplier.',
      ...
      compositeRoutes: {
        ...
        targetGroup: 'Target Account Group',
        targetGroupAuto: 'Use composite group scheduling',
