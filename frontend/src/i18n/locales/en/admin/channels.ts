export default {
    ...
    channelMonitor: {
      ...
      form: {
        ...
        newAPIToken: 'NewAPI personal access token',
        newAPIUserID: 'NewAPI user ID (if required by the site)',
        newAPIHint: 'Use a personal access token from the upstream profile, not a model API key. Balance is shown in raw quota units; exhaustion is degraded and query failures are shown as errors.',
