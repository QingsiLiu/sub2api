...
- 部署：2026-09-25 17:05（北京时间）已按固定 digest 部署 Stage；CI 全部通过，55项 Astra 专项 +281项通用业务验收通过，配置恢复。未部署生产，现网仍为 `0.2.8-geili.5`。候选流水线：`36113536572`；真实上游联调、候选双实例复验与当次生产授权待完成。
