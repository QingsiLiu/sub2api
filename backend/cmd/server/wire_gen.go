...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	publicPricingCatalogService := service.NewPublicPricingCatalogService(settingService, groupService, channelService, billingService, modelPricingResolver, apiKeyService)
	pricingCatalogHandler := handler.NewPricingCatalogHandler(publicPricingCatalogService)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, channelMonitorUserHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, handlerPaymentHandler, paymentWebhookHandler, availableChannelHandler, pricingCatalogHandler, asyncImageHandler, batchImageHandler, idempotencyCoordinator, idempotencyCleanupService)
