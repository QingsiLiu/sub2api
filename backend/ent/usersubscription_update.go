...
func (_u *UserSubscriptionUpdate) AddEntitlementOperationIDs(ids ...int64) *UserSubscriptionUpdate {
	_u.mutation.AddEntitlementOperationIDs(ids...)
	return _u
}

// AddEntitlementOperations adds the "entitlement_operations" edges to the SubscriptionOperation entity.
func (_u *UserSubscriptionUpdate) AddEntitlementOperations(v ...*SubscriptionOperation) *UserSubscriptionUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.AddEntitlementOperationIDs(ids...)
}
...
func (_u *UserSubscriptionUpdate) AddGroupEntitlementIDs(ids ...int64) *UserSubscriptionUpdate {
	_u.mutation.AddGroupEntitlementIDs(ids...)
	return _u
}

// AddGroupEntitlements adds the "group_entitlements" edges to the UserSubscriptionGroup entity.
func (_u *UserSubscriptionUpdate) AddGroupEntitlements(v ...*UserSubscriptionGroup) *UserSubscriptionUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *UserSubscriptionUpdate) AddEntitlementIDs(ids ...int64) *UserSubscriptionUpdate {
	_u.mutation.AddEntitlementIDs(ids...)
	return _u
}

// AddEntitlements adds the "entitlements" edges to the UserSubscriptionEntitlement entity.
func (_u *UserSubscriptionUpdate) AddEntitlements(v ...*UserSubscriptionEntitlement) *UserSubscriptionUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearEntitlementOperations clears all "entitlement_operations" edges to the SubscriptionOperation entity.
func (_u *UserSubscriptionUpdate) ClearEntitlementOperations() *UserSubscriptionUpdate {
	_u.mutation.ClearEntitlementOperations()
	return _u
}

// RemoveEntitlementOperationIDs removes the "entitlement_operations" edge to SubscriptionOperation entities by IDs.
func (_u *UserSubscriptionUpdate) RemoveEntitlementOperationIDs(ids ...int64) *UserSubscriptionUpdate {
	_u.mutation.RemoveEntitlementOperationIDs(ids...)
	return _u
}

// RemoveEntitlementOperations removes "entitlement_operations" edges to SubscriptionOperation entities.
func (_u *UserSubscriptionUpdate) RemoveEntitlementOperations(v ...*SubscriptionOperation) *UserSubscriptionUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.RemoveEntitlementOperationIDs(ids...)
}
...
// ClearGroupEntitlements clears all "group_entitlements" edges to the UserSubscriptionGroup entity.
func (_u *UserSubscriptionUpdate) ClearGroupEntitlements() *UserSubscriptionUpdate {
	_u.mutation.ClearGroupEntitlements()
	return _u
}

// RemoveGroupEntitlementIDs removes the "group_entitlements" edge to UserSubscriptionGroup entities by IDs.
func (_u *UserSubscriptionUpdate) RemoveGroupEntitlementIDs(ids ...int64) *UserSubscriptionUpdate {
	_u.mutation.RemoveGroupEntitlementIDs(ids...)
	return _u
}

// RemoveGroupEntitlements removes "group_entitlements" edges to UserSubscriptionGroup entities.
func (_u *UserSubscriptionUpdate) RemoveGroupEntitlements(v ...*UserSubscriptionGroup) *UserSubscriptionUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *UserSubscriptionUpdate) ClearEntitlements() *UserSubscriptionUpdate {
...
func (_u *UserSubscriptionUpdate) RemoveEntitlementIDs(ids ...int64) *UserSubscriptionUpdate {
...
func (_u *UserSubscriptionUpdate) RemoveEntitlements(v ...*UserSubscriptionEntitlement) *UserSubscriptionUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *UserSubscriptionUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.EntitlementOperationsCleared() {
	...
	if nodes := _u.mutation.RemovedEntitlementOperationsIDs(); len(nodes) > 0 && !_u.mutation.EntitlementOperationsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   usersubscription.EntitlementOperationsTable,
	...
	if nodes := _u.mutation.EntitlementOperationsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   usersubscription.EntitlementOperationsTable,
	...
	if _u.mutation.GroupEntitlementsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   usersubscription.GroupEntitlementsTable,
			Columns: []string{usersubscription.GroupEntitlementsColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
// AddEntitlementOperationIDs adds the "entitlement_operations" edge to the SubscriptionOperation entity by IDs.
func (_u *UserSubscriptionUpdateOne) AddEntitlementOperationIDs(ids ...int64) *UserSubscriptionUpdateOne {
	_u.mutation.AddEntitlementOperationIDs(ids...)
	return _u
}

// AddEntitlementOperations adds the "entitlement_operations" edges to the SubscriptionOperation entity.
func (_u *UserSubscriptionUpdateOne) AddEntitlementOperations(v ...*SubscriptionOperation) *UserSubscriptionUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddGroupEntitlementIDs adds the "group_entitlements" edge to the UserSubscriptionGroup entity by IDs.
func (_u *UserSubscriptionUpdateOne) AddGroupEntitlementIDs(ids ...int64) *UserSubscriptionUpdateOne {
	_u.mutation.AddGroupEntitlementIDs(ids...)
	return _u
}

// AddGroupEntitlements adds the "group_entitlements" edges to the UserSubscriptionGroup entity.
func (_u *UserSubscriptionUpdateOne) AddGroupEntitlements(v ...*UserSubscriptionGroup) *UserSubscriptionUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddEntitlementIDs adds the "entitlements" edge to the UserSubscriptionEntitlement entity by IDs.
func (_u *UserSubscriptionUpdateOne) AddEntitlementIDs(ids ...int64) *UserSubscriptionUpdateOne {
	_u.mutation.AddEntitlementIDs(ids...)
	return _u
}

// AddEntitlements adds the "entitlements" edges to the UserSubscriptionEntitlement entity.
func (_u *UserSubscriptionUpdateOne) AddEntitlements(v ...*UserSubscriptionEntitlement) *UserSubscriptionUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearEntitlementOperations clears all "entitlement_operations" edges to the SubscriptionOperation entity.
func (_u *UserSubscriptionUpdateOne) ClearEntitlementOperations() *UserSubscriptionUpdateOne {
	_u.mutation.ClearEntitlementOperations()
	return _u
}

// RemoveEntitlementOperationIDs removes the "entitlement_operations" edge to SubscriptionOperation entities by IDs.
func (_u *UserSubscriptionUpdateOne) RemoveEntitlementOperationIDs(ids ...int64) *UserSubscriptionUpdateOne {
	_u.mutation.RemoveEntitlementOperationIDs(ids...)
	return _u
}

// RemoveEntitlementOperations removes "entitlement_operations" edges to SubscriptionOperation entities.
func (_u *UserSubscriptionUpdateOne) RemoveEntitlementOperations(v ...*SubscriptionOperation) *UserSubscriptionUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearGroupEntitlements clears all "group_entitlements" edges to the UserSubscriptionGroup entity.
func (_u *UserSubscriptionUpdateOne) ClearGroupEntitlements() *UserSubscriptionUpdateOne {
	_u.mutation.ClearGroupEntitlements()
	return _u
}

// RemoveGroupEntitlementIDs removes the "group_entitlements" edge to UserSubscriptionGroup entities by IDs.
func (_u *UserSubscriptionUpdateOne) RemoveGroupEntitlementIDs(ids ...int64) *UserSubscriptionUpdateOne {
	_u.mutation.RemoveGroupEntitlementIDs(ids...)
	return _u
}

// RemoveGroupEntitlements removes "group_entitlements" edges to UserSubscriptionGroup entities.
func (_u *UserSubscriptionUpdateOne) RemoveGroupEntitlements(v ...*UserSubscriptionGroup) *UserSubscriptionUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearEntitlements clears all "entitlements" edges to the UserSubscriptionEntitlement entity.
func (_u *UserSubscriptionUpdateOne) ClearEntitlements() *UserSubscriptionUpdateOne {
	_u.mutation.ClearEntitlements()
	return _u
}

// RemoveEntitlementIDs removes the "entitlements" edge to UserSubscriptionEntitlement entities by IDs.
func (_u *UserSubscriptionUpdateOne) RemoveEntitlementIDs(ids ...int64) *UserSubscriptionUpdateOne {
	_u.mutation.RemoveEntitlementIDs(ids...)
	return _u
}

// RemoveEntitlements removes "entitlements" edges to UserSubscriptionEntitlement entities.
func (_u *UserSubscriptionUpdateOne) RemoveEntitlements(v ...*UserSubscriptionEntitlement) *UserSubscriptionUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
