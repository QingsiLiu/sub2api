...
func (*SubscriptionPlanGroup) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case subscriptionplangroup.FieldID, subscriptionplangroup.FieldSubscriptionPlanID, subscriptionplangroup.FieldGroupID:
...
func (_m *SubscriptionPlanGroup) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case subscriptionplangroup.FieldSubscriptionPlanID:
...
func (_m *SubscriptionPlanGroup) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", _m.SubscriptionPlanID))
	builder.WriteString(", ")
