...
func (e SubscriptionPlanEdges) GroupEntitlementsOrErr() ([]*SubscriptionPlanGroup, error) {
	if e.loadedTypes[0] {
...
// QueryGroupEntitlements queries the "group_entitlements" edge of the SubscriptionPlan entity.
func (_m *SubscriptionPlan) QueryGroupEntitlements() *SubscriptionPlanGroupQuery {
