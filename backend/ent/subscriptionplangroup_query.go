...
//		GroupBy(subscriptionplangroup.FieldSubscriptionPlanID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.SubscriptionPlanGroup.Query().
//		Select(subscriptionplangroup.FieldSubscriptionPlanID).
//		Scan(ctx, &v)
...
func (_q *SubscriptionPlanGroupQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withPlan != nil {
			_spec.Node.AddColumnOnce(subscriptionplangroup.FieldSubscriptionPlanID)
		}
		if _q.withGroup != nil {
