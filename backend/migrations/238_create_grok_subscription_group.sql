...
BEGIN
    ...
    IF target_id IS NULL THEN
        INSERT INTO groups (name, description, platform, subscription_type, rate_multiplier, is_exclusive, status,
            default_validity_days, model_routing, model_routing_enabled, fallback_group_id,
            allow_image_generation, allow_batch_image_generation, image_rate_independent, image_rate_multiplier,
            image_price_1k, image_price_2k, image_price_4k, video_rate_independent, video_rate_multiplier,
            ...
            search_price_per_1k, web_search_price_per_call, supported_model_scopes, models_list_config,
            long_context_pricing_enabled, model_pricing, allow_live, allow_messages_dispatch, default_mapped_model)
