...
const apiKeyAuthSnapshotVersion = 26 // v26: explicit settlement, ordered groups and subscription opt-in
...
func (s *APIKeyService) snapshotFromAPIKey(ctx context.Context, apiKey *APIKey) *APIKeyAuthSnapshot {
	...
	snapshot := &APIKeyAuthSnapshot{
		...
		RoutePreferences: apiKey.RoutePreferences,
		BillingSource:    apiKey.BillingSource, RoutingMode: apiKey.RoutingMode, GroupIDs: append([]int64(nil), apiKey.GroupIDs...),
		Name:        apiKey.Name,
...
func (s *APIKeyService) snapshotToAPIKey(key string, snapshot *APIKeyAuthSnapshot) *APIKey {
	...
	apiKey := &APIKey{
		...
		RoutePreferences: snapshot.RoutePreferences,
		BillingSource:    snapshot.BillingSource, RoutingMode: snapshot.RoutingMode, GroupIDs: append([]int64(nil), snapshot.GroupIDs...),
		Key:         key,
		Name:        snapshot.Name,
