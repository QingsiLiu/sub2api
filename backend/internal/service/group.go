...
// ValidatePeakRateConfig validates the shared peak factor for balance and
// subscription billing. A zero factor is an explicit free time window.
...
// NormalizePeakRateConfig preserves configured windows for both billing modes,
// and cleans invalid optional values when the peak factor is disabled.
